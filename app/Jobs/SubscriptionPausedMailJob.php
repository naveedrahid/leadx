...
use App\Mail\SubscriptionPausedMail;
use App\Models\{
    User,
    Subscription
};

class SubscriptionPausedMailJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        Mail::to($customer->email)->send(new SubscriptionPausedMail($customer, $subscription));
    }
}
