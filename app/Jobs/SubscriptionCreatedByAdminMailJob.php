...
use App\Mail\SubscriptionCreatedByAdminMail;
use App\Models\{
    User,
    Subscription,
    Coupon,
...
class SubscriptionCreatedByAdminMailJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        Mail::to($customer->email)->send(new SubscriptionCreatedByAdminMail($customer, $subscription, $package, $coupon));
    }
}
