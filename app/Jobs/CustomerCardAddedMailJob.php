...
use App\Mail\CustomerCardAddedMail;
use App\Models\User;

class CustomerCardAddedMailJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        Mail::to($customer->email)->send(new CustomerCardAddedMail($customer, $customer_card));
    }
}
