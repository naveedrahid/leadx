...
use App\Mail\UpcomingBillingReminder;
use App\Models\{
    Subscription,
    User
};

class UpcomingBillingReminderJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        Mail::to($customer->email)->send(new UpcomingBillingReminder($customer, $subscription));
    }
}
