...
This is to inform you that auto-renewal has been enabled for your subscription by our {{ config('app.name') }} team. Your subscription will now automatically renew at the end of each billing cycle.
