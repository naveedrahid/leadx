...
Welcome to {{ config('app.name') }}! We’re thrilled to have you on board. This is a quick note to let you know that your subscription has been successfully created by our {{ config('app.name') }} team. Below are the details of your subscription:
