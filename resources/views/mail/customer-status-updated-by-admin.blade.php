...
Your account status has been updated by our {{ config('app.name') }} team to: <strong>{{ $customer->status }}</strong>.

@if($customer->status == 'active')
You can now access all the features of our portal.
@else
Your access to the portal has been restricted.
@endif
