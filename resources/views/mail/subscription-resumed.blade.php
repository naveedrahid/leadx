...
We’re pleased to let you know that your subscription with {{ config('app.name') }} has resumed as of {{ Carbon\Carbon::parse($subscription->resumes_at)->format('M d Y') }}. You now have full access to all our services and features.
