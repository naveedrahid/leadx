...
We wanted to let you know that your subscription with {{ config('app.name') }} has been paused as of {{ Carbon\Carbon::parse($subscription->paused_at)->format('M d Y') }}. This means you won't be charged during the pause, and access to our services will be limited during this time.
