        ...
        <div class="container-fluid">
            ...
            <div class="mb-3">
                <div class="d-flex align-items-center justify-content-end gap-2">
                    <Link :href="route('app.customer.keyword.create')" class="btn btn-primary btn-sm">
            ...
            <div class="card">
                <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <div class="action-btn d-flex align-items-center gap-2">
                                                    <Link :href="route('app.customer.keyword.edit', [item.id])"
                    ...
                    <Pagination v-if="renderPaginate" :paginate="paginate" :url="route('app.customer.keyword.index')"
