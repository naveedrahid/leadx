            ...
            <div class="row">
                        ...
                        <div class="p-4 border-top mt-3">
                            <div class="row text-center">
                                <div class="col-6 border-end">
                                    <Link :href="route('app.customer.account_setting')" class="link text-dark d-flex align-items-center justify-content-center font-weight-medium">
                                        <i class="ti ti-user-cog me-1 fs-6"></i> Account Setting
                                    </Link>
                                </div>
                                <div class="col-6">
                                    <Link :href="route('app.customer.change_password')" class="link text-dark d-flex align-items-center justify-content-center font-weight-medium">
                ...
                <div class="col-md-7">
                    <div class="card border">
                        <div class="card-body">
                            <h5 class="card-title fw-semibold">Account Setting</h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex align-items-center gap-2 mt-5">
                                            ...
                                            <a :href="route('app.customer.dashboard')" class="btn btn-light-danger text-danger">
    ...
    methods: {
        ...
        async accountSetting() {
            ...
            await axios.post(route('api.auth.account.setting'), fd, {
                ...
                this.$inertia.visit(route('app.customer.account_setting'));
                this.loader = false;
            }).catch((error) => {
                this.loader = false;
