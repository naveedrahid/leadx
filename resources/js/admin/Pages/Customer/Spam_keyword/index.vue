<template>
    ...
    <AppLayout ref="app_layout" :loader="loader">
        <div class="container-fluid">
            <Breadcrumb>
                <template v-slot:title>Spam Leads</template>
                <li class="breadcrumb-item text-muted" aria-current="page">Spam Leads</li>
            </Breadcrumb>
            <div class="mb-3">
                <div class="d-flex align-items-center justify-content-end gap-2">
                    <Link :href="route('app.customer.spam-leads.index')" class="btn btn-dark btn-sm"><i
...
export default {
    ...
    methods: {
        ...
        async getData(page = this.page) {
            ...
            await axios.get(route('api.spam-leads.get.all'), {
                params: params,
                headers: {
                    "Content-Type": "application/json",
                    Authorization: "Bearer " + this.token,
