        ...
        <div class="container-fluid">
                            ...
                            <TransitionGroup tag="tbody" name="fade">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <div class="d-flex flex-wrap align-items-center gap-2">
                                                <Link :href="route('app.admin.customer.subscription.billing', [$page.props.id])" class="btn btn-primary btn-sm" v-if="Object.keys(customer).length>0 && customer.status == 'active'">Billing Information</Link>
                                            </div>
                                        </td>
                                    </tr>
                                </template>
                                <template v-else-if="Object.keys(subscription).length>0">
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <div class="d-flex flex-wrap align-items-center gap-2">
                                                <Link :href="route('app.admin.customer.subscription.billing', [$page.props.id])" class="btn btn-info btn-sm">Take a Plan</Link>
                                            </div>
                                        </td>
                                    </tr>
                                </template>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <Pagination v-if="renderPaginate" :paginate="paginate" :url="route('app.admin.customer.subscription', [$page.props.id])" :current="page" @items="getData"></Pagination>
                    <div v-if="renderPaginate" class="text-end fs-1 fw-bold text-capitalize py-2">Showing {{ paginate.from ? paginate.from : 0 }} to {{ paginate.to ? paginate.to : 0 }} of {{ paginate.total ? paginate.total : 0 }} records</div>
                </div>
            </div>
        </div>
