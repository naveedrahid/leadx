                    ...
                    <template v-if="Object.keys(current_subscription).length>0">
                        ...
                        <div class="rounded border border-2 p-4 mb-4">
                            ...
                            <div class="d-flex align-items-center gap-2 mt-5">
                                <Link :href="route('app.admin.customer.subscription.billing', [$page.props.id])" class="btn btn-primary">Manage Billing</Link>
                            </div>
                        </div>
                    </template>
                    <template v-else>
                        <template v-if="Object.keys(subscription).length>0">
                            <div class="rounded border border-2 p-4 mb-4">
                                ...
                                <div class="d-flex align-items-center gap-2 mt-5">
                                    <Link :href="route('app.admin.customer.subscription.billing', [$page.props.id])" class="btn btn-primary">Take a Plan</Link>
                                </div>
                            </div>
                        </template>
                    </template>
