    ...
    <AppLayout ref="app_layout" :loader="loader">
        <div class="container-fluid">
            <Breadcrumb>
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Keyword</li>
            </Breadcrumb>
                ...
                <div class="card-body p-4">
                    <form @submit.prevent="submit">
                        ...
                        <div class="d-flex align-items-center gap-2 mt-5">
                            ...
                            <a :href="route('app.admin.keyword.index')" class="btn btn-light-danger text-danger">
...
export default {
    ...
    data() {
        return {
            ...
            form: {
                id: this.keyword?.id ?? null,
                keyword: this.keyword?.keyword ?? '',
                status: this.keyword?.status ?? 'inactive',
            },
            errors: {},
            loader: false,
        };
    ...
    methods: {
        async submit() {
            ...
            await axios.put(route('api.keyword.update', this.form.id), this.form, {
                headers: {
