<template>
    <Head title="Edit Plugin Details" />
    <AppLayout ref="app_layout" :loader="loader">
        <div class="container-fluid">
            <Breadcrumb>
                <template v-slot:title>Edit Plugin Details</template>
...
export default {
    ...
    methods: {
        ...
        async getItem() {
            this.loader = true;
            await axios.get(route('api.plugin.get.single', [this.$page.props.id]), {
                headers: {
                ...
                this.form.plugin_name = this.item.plugin_name ? this.item.plugin_name : '';
                this.form.plugin_url = this.item.plugin_url ? this.item.plugin_url : '';
                this.form.version = this.item.version ? this.item.version : '';
                this.form.documentation = this.item.documentation ? this.item.documentation : '';
        ...
        async updateItem() {
            ...
            await axios.post(route('api.plugin.update', [this.$page.props.id]), fd, {
                headers: {
