                        ...
                        <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up border">
                            <div class="profile-dropdown position-relative" data-simplebar>
                                ...
                                <div class="message-body">
                                    <Link :href="route('app.admin.account_setting')" class="py-8 px-7 d-flex align-items-center bg-hover-light">
                                        <span class="fs-6"><i class="ti ti-user-cog"></i></span>
                                        <div class="w-75 d-inline-block v-middle ps-3">
                                            <h6 class="mb-1 fw-semibold">Account Settings</h6>
                                        </div>
                                    </Link>
                                    <Link :href="route('app.admin.change_password')" class="py-8 px-7 d-flex align-items-center bg-hover-light">
